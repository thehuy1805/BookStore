...
namespace FPTBook.Controllers
{
    public class AuthorController : Controller
    {
        ...
        public AuthorController(FPTBookIdentityDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Author != null ? 
                          ...
                          Problem("Entity set 'FPTBookIdentityDbContext.Author'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FPTBookIdentityDbContext.Author'  is null.");
            }
            var author = await _context.Author.FindAsync(id);
            if (author != null)
            {
