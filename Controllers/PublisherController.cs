...
namespace FPTBook.Controllers
{
    public class PublisherController : Controller
    {
        ...
        public PublisherController(FPTBookIdentityDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publisher != null ? 
                          ...
                          Problem("Entity set 'FPTBookIdentityDbContext.Publisher'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FPTBookIdentityDbContext.Publisher'  is null.");
            }
            var publisher = await _context.Publisher.FindAsync(id);
            if (publisher != null)
            {
